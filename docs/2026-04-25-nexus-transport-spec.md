...
- **Nexus can't reach into hosts directly.** Aspects live wherever their operators put them — <operator-host> (macOS), dMon (Windows), nexus-cw-ec2 (Linux), forge's WSL/Ubuntu. Nexus has no inventory of those hosts beyond "an Outpost identifies as being on host X."
