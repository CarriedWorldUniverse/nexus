...
**Origins allow-list spans both ports** so a single passkey works on `:18888` and `:7888`. The cutover command sets `NEXUS_OPERATOR_ORIGINS=https://agentnetwork.tail41686e.ts.net:18888,https://agentnetwork.tail41686e.ts.net:7888`.
...
for aspect in forge wren verity keel harrow maren anvil plumb:
  nexus aspect mint $aspect --out C:\src\nexus-cw\data\keyfiles\$aspect.keyfile.json --nexus-url wss://agentnetwork.tail41686e.ts.net:7888 --data-dir C:\src\nexus-cw\data
...
$env:NEXUS_OPERATOR_RPID = "agentnetwork.tail41686e.ts.net"
$env:NEXUS_OPERATOR_ORIGINS = "https://agentnetwork.tail41686e.ts.net:18888,https://agentnetwork.tail41686e.ts.net:7888"
...
- `operator login enabled rp_id=agentnetwork.tail41686e.ts.net origins=[https://agentnetwork.tail41686e.ts.net:18888 https://agentnetwork.tail41686e.ts.net:7888]`
...
Open in browser: `https://agentnetwork.tail41686e.ts.net:18888/dashboard/`
...
```powershell
Push-Location C:\src\nexus-cw\nexus
$env:NEXUS_URL = "wss://agentnetwork.tail41686e.ts.net:18888"
...
$env:NEXUS_DATA_DIR = "C:\src\nexus-cw\data"
$env:NEXUS_INSECURE = "0"
.\nexus-wstest.exe -url wss://agentnetwork.tail41686e.ts.net:18888 -data-dir C:\src\nexus-cw\data -insecure -surface operator -filter knowledge.list 2>&1
Pop-Location
```
...
Open `https://agentnetwork.tail41686e.ts.net:7888/dashboard/`. **Same passkey** (the origins allow-list covers both ports).
...
```powershell
Push-Location C:\src\nexus-cw\nexus
$env:NEXUS_URL = "wss://agentnetwork.tail41686e.ts.net:7888"
$env:NEXUS_DATA_DIR = "C:\src\nexus-cw\data"
$env:NEXUS_INSECURE = "0"
go run ./scripts/cutover-smoke
Pop-Location
