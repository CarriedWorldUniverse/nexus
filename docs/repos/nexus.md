<!-- GENERATED FILE — do not edit.
     Sourced from https://github.com/CarriedWorldUniverse/nexus/blob/HEAD/README.md
     by scripts/sync-repo-readmes.sh at docs build time.
     Edit that README, not this file. -->

!!! info "Sourced from the repo README"
    This page mirrors [`nexus`](https://github.com/CarriedWorldUniverse/nexus)'s live `README.md`.
...
[![License](https://img.shields.io/github/license/CarriedWorldUniverse/nexus)](https://github.com/CarriedWorldUniverse/nexus/blob/HEAD/LICENSE)
...
under [`docs/`](https://github.com/CarriedWorldUniverse/nexus/blob/HEAD/docs/) (the dated files are the decision trail).
...
`shadow.umbra` — extend the [named-agent dispatch model](https://github.com/CarriedWorldUniverse/nexus/blob/HEAD/docs/2026-06-08-named-agent-dispatch-model.md)
and are in flight.)*
...
See [`LICENSE`](https://github.com/CarriedWorldUniverse/nexus/blob/HEAD/LICENSE).
